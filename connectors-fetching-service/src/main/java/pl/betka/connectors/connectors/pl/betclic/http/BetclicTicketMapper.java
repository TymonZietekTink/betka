...
import static pl.betka.connectors.connectors.pl.betclic.http.BetclicMappers.BET_RESULT_MAPPER;
import static pl.betka.connectors.connectors.pl.betclic.http.BetclicMappers.CATEGORY_MAPPER;
import static pl.betka.connectors.connectors.pl.betclic.http.BetclicMappers.EVENT_STATUS_MAPPER;
import static pl.betka.connectors.connectors.pl.betclic.http.BetclicMappers.SELECTION_TYPE_MAPPER;
import static pl.betka.connectors.connectors.pl.betclic.http.BetclicMappers.TICKET_RESULT_MAPPER;
import static pl.betka.connectors.connectors.pl.betclic.http.BetclicMappers.TICKET_TYPE_MAPPER;
...
import pl.betka.connectors.connectors.pl.betclic.http.entity.BetclicBet;
import pl.betka.connectors.connectors.pl.betclic.http.entity.BetclicTicket;
