package pl.betka.infrastructure.kafka.consumer.config;
...
import pl.betka.infrastructure.kafka.config.data.KafkaConfigData;
import pl.betka.infrastructure.kafka.config.data.KafkaConsumerConfigData;
